...
def independentPair(a1, a2):
  ...
  """
  sA1Add = set(a1.getAdd())
  sA2Add = set(a2.getAdd())
  sA1Del = set(a1.getDelete())
  sA2Del = set(a2.getDelete())


  if not (sA1Add & sA2Del or  sA2Add & sA1Del):
    sA1Pre = set(a1.getPre())
    sA2Pre = set(a2.getPre())
    if not (sA1Pre & sA2Del or  sA2Pre & sA1Del):
      return True;
